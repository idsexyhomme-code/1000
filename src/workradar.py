...
_FAMILY_KEYWORDS = [
    ("science", ("biologist", "chemist", "physicist", "statistician", "economist", "scientist", "geologist", "meteorolog", "lab-tech", "epidemiolog", "clinical-research", "mathematic", "astronom")),
    ("healthcare", ("nurse", "doctor", "pharmacist", "medical", "radiologist", "therapist", "dental", "dietitian", "social-worker", "veterinar", "surgeon", "psychiatr", "psycholog", "phlebot", "paramedic", "optometr", "midwife", "dermatolog", "cardiolog", "surgical", "ultrasound", "mri-", "home-health", "caregiver", "emt", "respiratory", "icu-")),
    ("trades", ("electrician", "plumber", "mechanic", "chef", "hairstylist", "trainer", "truck-driver", "flight-attendant", "construction", "carpenter", "welder", "hvac", "painter", "landscaper", "baker", "tailor", "butcher", "security-guard", "firefighter", "police", "warehouse", "delivery", "roofer", "mason", "locksmith", "janitor", "farmer", "barista", "bartender", "waiter", "pilot", "air-traffic", "flight-instructor", "machinist", "cnc", "crane", "forklift", "glazier", "ironworker", "pest", "appliance", "dog-groomer", "nanny", "bus-driver", "train-conductor", "ship-captain", "courier", "postal", "customs-officer", "park-ranger", "lifeguard", "drone", "esthetician", "nail-tech", "barber", "funeral", "sommelier", "florist", "tour-guide", "surveyor")),
    ("tech", ("developer", "software-architect", "engineer", "data-analyst", "data-scientist", "data-engineer", "ml-", "qa-", "sysadmin", "security", "devops", "sre", "prompt-engineer", "blockchain", "it-support", "cloud-", "database-admin", "network-engineer", "technical-support", "robotics", "hardware", "firmware", "automation-engineer", "gis-", "salesforce", "no-code", "release-manager")),
    ("creative", ("designer", "illustrator", "animator", "editor", "photographer", "art-", "3d-", "game-", "motion", "interior", "fashion", "voice-actor", "musician", "concept-artist", "storyboard", "colorist", "sound-designer", "music-producer", "songwriter", "film-director", "cinematographer", "makeup", "tattoo", "comic", "dj", "set-designer", "logo", "retoucher", "food-stylist", "lighting-designer", "jewelry", "photo-editor")),
    ("writing", ("writer", "journalist", "translator", "screenwriter", "proofreader", "seo-", "podcaster", "content", "ghostwriter", "grant-writer", "columnist", "fact-checker", "transcriptionist", "news-anchor", "novelist", "interpreter", "speechwriter", "localization", "captioner")),
    ("marketing", ("marketer", "marketing", "pr-", "brand", "social-media", "email-marketer", "market-researcher", "influencer")),
    ("finance", ("account", "bookkeeper", "financial", "auditor", "tax-", "investment", "actuary", "loan-", "payroll", "insurance", "credit-analyst", "underwriter", "claims", "billing", "treasury", "quant", "mortgage", "stockbroker", "budget-analyst", "forensic", "controller", "fpa", "collections", "equity-research", "revenue-analyst")),
    ("legal", ("paralegal", "lawyer", "legal", "contract", "compliance", "court-reporter", "mediator", "patent", "title-examiner", "notary", "e-discovery", "regulatory", "court-clerk")),
    ("support", ("support", "customer", "call-center", "receptionist", "virtual-assistant", "community", "concierge", "bank-teller", "dispatcher")),
    ("education", ("teacher", "professor", "tutor", "instructional", "counselor", "librarian", "teaching-assistant", "curriculum", "academic-advisor", "esl-", "kindergarten", "special-ed", "music-teacher", "online-course")),
    ("business", ("manager", "analyst", "consultant", "assistant", "admin", "scrum", "recruiter", "sales", "account-exec", "real-estate", "travel-agent", "event-planner", "urban-planner", "architect", "logistics", "procurement", "data-entry", "chief-of-staff", "business-development", "partnerships", "cashier", "merchandiser", "buyer", "customs-broker", "property-appraiser", "change-manager", "risk-manager", "program-manager")),
]
